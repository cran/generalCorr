...
#' \item{dj}{Vector of distances when both sets of data are forced on a common support} 
...
#'  utility theory which inocorporates commonly observed human behavior favoring
